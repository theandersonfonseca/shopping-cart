  ...
  return (
    <S.Wrapper>
      ...
      <S.ProductQuantityWrapper>
        <S.IncreaseProductQuantity onClick={increaseProduct}>{'<'}</S.IncreaseProductQuantity>
        <S.ProductQuantity>{quantity}</S.ProductQuantity>
        <S.DecreaseProductQuantity onClick={decreaseProduct}>{'>'}</S.DecreaseProductQuantity>
      </S.ProductQuantityWrapper>
    </S.Wrapper>
  )
}
